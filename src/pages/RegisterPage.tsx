    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (response.user.role === "admin") {
                ...
                // Drivers start as inactive, maybe redirect to a specific status page but for now dashboard or login
                navigate("/driver/dashboard");
            }
        } catch (err: any) {
            dispatch(
        ...
        <div className="w-full lg:grid lg:min-h-screen lg:grid-cols-2 xl:min-h-screen">
                ...
                <div className="mx-auto w-[400px] space-y-6">
                    <div className="flex flex-col space-y-2 text-center">
                        ...
                        <p className="text-balance text-muted-foreground">
                            Enter your information to get started with CamYou Fleet
                        </p>
                    </div>
            ...
            <div className="hidden bg-muted lg:block relative overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-12 text-white">
                    <div className="space-y-2">
                        <h2 className="text-3xl font-bold">Join the Future of Transport</h2>
                        <p className="text-lg text-gray-200">Empower your team with advanced fleet analytics and management tools.</p>
                    </div>
                </div>
            </div>
        </div>
